...
frappe.ui.form.on('Production Entry', {
    ...
    item_to_manufacture: function(frm) {
        if (frm.doc.item_to_manufacture) {
            ...
            frappe.call({
                method: "ext_accounts.ruxsora_app.doctype.production_entry.production_entry.get_bom_for_item",
                args: {
...
function fetch_bom_items(frm) {
    frappe.call({
        method: "ext_accounts.ruxsora_app.doctype.production_entry.production_entry.get_bom_items",
        args: {
...
function update_available_qty(frm, row) {
    frappe.call({
        method: "ext_accounts.ruxsora_app.doctype.production_entry.production_entry.get_available_qty_for_item",
        args: {
